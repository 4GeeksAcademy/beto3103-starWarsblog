                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">{detailCharacter?.description}</p>
                                </div>
                                <div className="detail-divider mt-3 d-flex text-danger">
                                    <div className="row my-2">
                                        <p className="m-1 p-1 fw-bold">Name</p>
                                        <p className="m-1 p-1">{detailCharacter?.name}</p>
                                    </div>
                                    <div className="row my-2 ">
                                        <p className="m-1 p-1 fw-bold">Birth Year</p>
                                        <p className="m-1 p-1">{detailCharacter?.birth_year}</p>
                                    </div>
                                    <div className="row my-2">
                                        <p className="m-1 p-1 fw-bold">Gender</p>
                                        <p className="m-1 p-1">{detailCharacter?.gender}</p>
                                    </div>
                                    <div className="row my-2">
                                        <p className="m-1 p-1 fw-bold">Height</p>
                                        <p className="m-1 p-1">{detailCharacter?.height}</p>
                                    </div>
                                    <div className="row my-2">
                                        <p className="m-1 p-1 fw-bold">Skin Color</p>
                                        <p className="m-1 p-1">{detailCharacter?.skin_color}</p>
                                    </div>
                                    <div className="row my-2">
                                        <p className="m-1 p-1 fw-bold">Eye Color</p>
                                        <p className="m-1 p-1">{detailCharacter?.eye_color}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
